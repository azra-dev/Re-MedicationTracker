...
namespace MedicationTracker.Core
{
    internal class DataAccessLayer : ObservableObject
    {
        ...
        public string connectionString = @"Server=192.168.1.9,1433;Database=MediTrack;User ID=tester;Password=meditrack;Integrated Security=False;Trusted_Connection=False;";
